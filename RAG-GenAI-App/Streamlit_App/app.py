...
model_id = "amazon.nova-micro-v1:0" # This is the model ID. You can find this in Bedrock under the model you want to use.
region = "us-east-1" 
kb_id = "Replace with your own KB ID" # This is the knowledge base ID
...
for chat in reversed(st.session_state['history']):
    ...
    with col2_q:
        st.text_area("Q:", value=chat["question"], height=175, key=str(chat)+"q", disabled=True)
